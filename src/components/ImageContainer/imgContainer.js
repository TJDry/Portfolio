...
export default function ImgContainer(props){
    if (props.image3 !== undefined) {
        ...
        <div className = {`${styles.imgContainer} ${styles.flex} ${styles[props.class]}`}>
            ...
            <div className={styles.imgBorder}><img src={process.env.PUBLIC_URL + `/images/${props.projectTitle}/${props.image1}`} alt="imageGoesHere"></img></div>
            <div className={styles.imgBorder}><img src={process.env.PUBLIC_URL + `/images/${props.projectTitle}/${props.image2}`} alt="imageGoesHere"></img></div>
            <div className={styles.imgBorder}><img src={process.env.PUBLIC_URL + `/images/${props.projectTitle}/${props.image3}`} alt="imageGoesHere"></img></div>
        </div>
        )
